...
//   UserDetailsService para implementar metodos abstractos para poder autenticar usuarios
   ...
   @Autowired
   private PropiedadServicio propiedadService;
...
//    public void agregarPropiedadUsuario(String usuarioId, String propiedadId) {
//        Usuario usuario = usuarioRepositorio.findById(usuarioId).orElseThrow(() -> new RuntimeException("Usuario no encontrado"));
//        Propiedad propiedad = propiedadService.getPropiedadById(propiedadId);
